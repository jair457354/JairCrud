...
namespace UTTT.Ejemplo.Linq.Data.Entity
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="persona1")]
    ...
    partial void DeleteUsuarios(Usuarios instance);
		...
		public DcGeneralDataContext() : 
				base(global::UTTT.Ejemplo.Linq.Data.Properties.Settings.Default.persona1ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnidCatEstadoCivilChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dteFechaNac", DbType="VarChar(10)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Usuarios", Storage="_Usuarios", ThisKey="id", OtherKey="idPersona")]
    ...
    partial void OnstrDescripcionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CatUsuario_Usuarios", Storage="_Usuarios", ThisKey="id", OtherKey="idCatEstado")]
		public EntitySet<Usuarios> Usuarios
		{
			get
			{
	...
	public partial class Usuarios : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _idCatEstado;
		
		private int _idPersona;
		
		private string _dteFecha;
    ...
    partial void OnconstraseniaChanging(string value);
    partial void OnconstraseniaChanged();
    partial void OnidCatEstadoChanging(System.Nullable<int> value);
    partial void OnidCatEstadoChanged();
    partial void OnidPersonaChanging(int value);
    partial void OnidPersonaChanged();
    partial void OndteFechaChanging(string value);
    ...
    partial void OntokenChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_constrasenia", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string constrasenia
		{
			get
			{
				return this._constrasenia;
			}
			set
			{
				if ((this._constrasenia != value))
				{
					this.OnconstraseniaChanging(value);
					this.SendPropertyChanging();
					this._constrasenia = value;
					this.SendPropertyChanged("constrasenia");
					this.OnconstraseniaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idCatEstado", DbType="Int")]
		public System.Nullable<int> idCatEstado
		{
			get
			{
				return this._idCatEstado;
			}
			set
			{
				if ((this._idCatEstado != value))
				{
					if (this._CatUsuario.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnidCatEstadoChanging(value);
					this.SendPropertyChanging();
					this._idCatEstado = value;
					this.SendPropertyChanged("idCatEstado");
					this.OnidCatEstadoChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dteFecha", DbType="VarChar(50)")]
		public string dteFecha
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CatUsuario_Usuarios", Storage="_CatUsuario", ThisKey="idCatEstado", OtherKey="id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._CatUsuario.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._idCatEstado = value.id;
					}
					else
					{
						this._idCatEstado = default(Nullable<int>);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Usuarios", Storage="_Persona", ThisKey="idPersona", OtherKey="id", IsForeignKey=true)]
		public Persona Persona
		{
			get
			{
