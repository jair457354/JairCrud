...
namespace UTTT.Ejemplo.Persona
{
            ...
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        this.TextBox1.Text = this.baseEntity.dteFechaNac;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.idPersona == 0)
                    {
                        ...
                        persona.dteFechaNac = this.TextBox1.Text.Trim();
                    ...
                    if (this.idPersona > 0)
                    {
                        ...
                        persona.strRFC = this.txtRFC.Text.Trim();
                        //DateTime fechaNacimiento1 = Convert.ToDateTime(TextBox1.Text);
                        //persona.dteFechaNac = Convert.ToString(fechaNacimiento1);

                        persona.dteFechaNac = this.TextBox1.Text.Trim();

                        //DateTime fechaNacimiento1 = Convert.ToDateTime(Calendar1.SelectedDate);
                        //persona.dteFechaNac = Convert.ToString(fechaNacimiento1);
    ...
    public void Correo(string correoDestino, string asunto, string mensajeCorreo)
        ...
        public bool validacion(UTTT.Ejemplo.Linq.Data.Entity.Persona _persona, ref String _mensaje)
        {
            ...
            //if (_persona.dteFechaNac.Length > 10)
            //{
            //    _mensaje = " Los caracteres de Fecha de Nacimiento, rebasan los establecidos";
            //    return false;
            //}
        ...
        public bool validacionHTML(ref String _mensaje)
        {
            ...
            if (valida.htmlInyectionValida(this.TextBox1.Text.Trim(), ref mensajefuncion, "Fecha de Nacimiento", ref this.TextBox1))
            {
                _mensaje = mensajefuncion;
                return false;
            }
        ...
        public bool validacionSQL(ref String _mensaje)
        {
            ...
            if (valida.sqlInyectionValida(this.TextBox1.Text.Trim(), ref mensajefuncion, "Fecha de Nacimiento", ref this.TextBox1))
            {
                _mensaje = mensajefuncion;
                return false;
            }
        ...
        protected void ddlEstadoCivil_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                List<CatEstadoCivil> listaE = dcGlobal.GetTable<CatEstadoCivil>().Where(predicateEstadoCivil).ToList();
                CatEstadoCivil catTemp1 = new CatEstadoCivil();
                this.ddlEstadoCivil.DataTextField = "strValor";
                this.ddlEstadoCivil.DataValueField = "id";
                this.ddlEstadoCivil.DataSource = listaE;
